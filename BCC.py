...
for i in range(2*x):
    for j in range(int(x/2)):
        for k in range(int(x/2)):
            ...
            print(" "*(5-len(str(met)))+f"{met}MET", " H", " "*(6-len(str(atom)))+str(atom),\
                " "*(9-len(str('{:.3f}'.format(round(2*a*i+rch, 3)))))+str('{:.3f}'.format(round(2*a*i+rch, 3))),\
                    " "*(8-len(str('{:.3f}'.format(round(2*a*j+rch, 3)))))+str('{:.3f}'.format(round(2*a*j+rch, 3))),\
                        " "*(8-len(str('{:.3f}'.format(round(2*a*k+rch, 3)))))+str('{:.3f}'.format(round(2*a*k+rch, 3))))
            atom += 1
            print(" "*(5-len(str(met)))+f"{met}MET", " H", " "*(6-len(str(atom)))+str(atom),\
                " "*(9-len(str('{:.3f}'.format(round(2*a*i+rch, 3)))))+str('{:.3f}'.format(round(2*a*i+rch, 3))),\
                    " "*(8-len(str('{:.3f}'.format(round(2*a*j-rch, 3)))))+str('{:.3f}'.format(round(2*a*j-rch, 3))),\
    ...
    for j in range(int(x/2)):
        for k in range(int(x/2)):
            ...
            atom += 1
            print(" "*(5-len(str(met)))+f"{met}MET", " H", " "*(6-len(str(atom)))+str(atom),\
                " "*(9-len(str('{:.3f}'.format(round(2*a*i+a+rch, 3)))))+str('{:.3f}'.format(round(2*a*i+a+rch, 3))), \
                    " "*(8-len(str('{:.3f}'.format(round(2*a*j+a+rch, 3)))))+str('{:.3f}'.format(round(2*a*j+a+rch, 3))),\
                        " "*(8-len(str('{:.3f}'.format(round(2*a*k+a+rch, 3)))))+str('{:.3f}'.format(round(2*a*k+a+rch, 3))))
            atom += 1
            print(" "*(5-len(str(met)))+f"{met}MET", " H", " "*(6-len(str(atom)))+str(atom),\
                " "*(9-len(str('{:.3f}'.format(round(2*a*i+a+rch, 3)))))+str('{:.3f}'.format(round(2*a*i+a+rch, 3))), \
                    " "*(8-len(str('{:.3f}'.format(round(2*a*j+a-rch, 3)))))+str('{:.3f}'.format(round(2*a*j+a-rch, 3))),\
